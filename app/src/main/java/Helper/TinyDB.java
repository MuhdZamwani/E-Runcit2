...
//
//
//    public ArrayList<Cart> getListObject(String key){
//        Gson gson = new Gson();
//
...
//            Cart player  = gson.fromJson(jObjString,  Cart.class);
...
//    }
//
//    public void putListObject(String key, ArrayList<Cart> playerList){
//        checkForNullKey(key);
//        Gson gson = new Gson();
//        ArrayList<String> objStrings = new ArrayList<String>();
//        for(Cart player: playerList){
