...
public class ToiletriesAdapter extends FirebaseRecyclerAdapter<Products,ToiletriesAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public ToiletriesAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ToiletriesAdapter.ViewHolder holder, int position, @NonNull Products products) {
    ...
    @NonNull
    @Override
    public ToiletriesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
