...
public class StationaryAdapter extends FirebaseRecyclerAdapter<Products,StationaryAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public StationaryAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
