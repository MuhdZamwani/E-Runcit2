...
public class SpicesAdapter extends FirebaseRecyclerAdapter<Products, SpicesAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public SpicesAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
