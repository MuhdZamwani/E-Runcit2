...
public class MedicineAdapter extends FirebaseRecyclerAdapter<Products, MedicineAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public MedicineAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull MedicineAdapter.ViewHolder holder, int position, @NonNull Products products) {
