...
public class LaundryAdapter extends FirebaseRecyclerAdapter<Products, LaundryAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public LaundryAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
