...
public class KitchenWareAdapter extends FirebaseRecyclerAdapter<Products, KitchenWareAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public KitchenWareAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
