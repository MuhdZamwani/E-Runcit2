...
public class RiceAdapter extends FirebaseRecyclerAdapter<Products, RiceAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public RiceAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
