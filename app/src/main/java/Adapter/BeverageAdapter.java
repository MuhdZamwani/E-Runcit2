...
public class BeverageAdapter extends FirebaseRecyclerAdapter<Products, BeverageAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public BeverageAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
