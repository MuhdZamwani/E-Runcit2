...
public class BreadAdapter extends FirebaseRecyclerAdapter<Products, BreadAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public BreadAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
