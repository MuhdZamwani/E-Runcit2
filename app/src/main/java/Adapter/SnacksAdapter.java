...
public class SnacksAdapter extends FirebaseRecyclerAdapter<Products, SnacksAdapter.ViewHolder> {
    /**
     ...
     * @param options
     */
    public SnacksAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, int i, @NonNull Products products) {
