...
import Adapter.ToiletriesAdapter;
import Model.Products;

public class ToiletriesInterface extends AppCompatActivity {
    ...
    private RecyclerView recyclerViewToiletries;
    private ToiletriesAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ct_toiletries_interface);

        cushome = findViewById(R.id.CusHomeBtnToiletries);
        ...
        cusprofile = findViewById(R.id.CusProfileBtnToiletries);
        ...
        cusorder = findViewById(R.id.CusMyOrderBtnToiletries);
        ...
        cusmanual = findViewById(R.id.CusManualBtnToiletries);
        ...
        cuscart = (ImageButton) findViewById(R.id.card_btn_Toiletries);
    ...
    private void DisToiletriesPro() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        recyclerViewToiletries = findViewById(R.id.Toiletrieslistitem);
        recyclerViewToiletries.setLayoutManager(linearLayoutManager);

        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>().
                setQuery(FirebaseDatabase.getInstance()
                        .getReference().child("Products").orderByChild("Category").equalTo("Toiletries"),Products.class)
                .build();

        adapter = new ToiletriesAdapter(options);
        recyclerViewToiletries.setAdapter(adapter);
    }
