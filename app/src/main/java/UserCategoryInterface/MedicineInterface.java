...
public class MedicineInterface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ct_medicine_interface);

        cushome = findViewById(R.id.CusHomeBtnMedicine);
        ...
        cusprofile = findViewById(R.id.CusProfileBtnMedicine);
        ...
        cusorder = findViewById(R.id.CusMyOrderBtnMedicine);
        ...
        cusmanual = findViewById(R.id.CusManualBtnMedicine);
        ...
        cuscart = (ImageButton) findViewById(R.id.card_btn_Medicine);
    ...
    private void DisMecidinePro() {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        recyclerViewMedicine = findViewById(R.id.Medicinelistitem);
        recyclerViewMedicine.setLayoutManager(linearLayoutManager);

        FirebaseRecyclerOptions<Products> options = new FirebaseRecyclerOptions.Builder<Products>().
                setQuery(FirebaseDatabase.getInstance()
                        .getReference().child("Products").orderByChild("Category").equalTo("Medicine"),Products.class)
                .build();
